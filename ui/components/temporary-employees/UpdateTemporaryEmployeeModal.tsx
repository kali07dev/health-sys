...
interface UpdateTemporaryEmployeeModalProps {
  isOpen: boolean
  onClose: () => void
  onUpdate: (employee: Partial<TemporaryEmployee>) => void
  employee: TemporaryEmployee
}

export function UpdateTemporaryEmployeeModal({ 
  isOpen, 
  onClose, 
  onUpdate,
  employee 
}: UpdateTemporaryEmployeeModalProps) {
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-xl rounded-lg bg-white p-6 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <Dialog.Title className="text-lg text-black font-medium">Edit Temporary Employee</Dialog.Title>
            <button
              onClick={onClose}
