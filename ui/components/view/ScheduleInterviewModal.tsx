...
import { SearchEmployee, type Employee } from "@/components/SearchEmployee"
...
export const ScheduleInterviewModal = ({ investigationId, onClose, onSchedule }: ScheduleInterviewModalProps) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            {selectedEmployee && (
              <div className="mt-2 p-2 bg-gray-50 rounded-md text-sm text-gray-900">
