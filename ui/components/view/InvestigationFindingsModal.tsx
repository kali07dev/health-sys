...
export const InvestigationFindingsModal = ({ investigationId, onClose, onSubmit }: InvestigationFindingsModalProps) => {
            ...
            {formData.contributingFactors.map((factor, index) => (
              <div key={index} className="flex items-center mb-2 last:mb-0">
                <textarea
                  ...
                  rows={2}
                  className="flex-grow p-2 border border-gray-300 rounded-md focus:ring-red-500 focus:border-red-500 text-gray-900"
